...
public class App 
{
    public static void main( String[] args )
    {
    	// to obtain/get the session from sessionfactory (It can be multiple session based on multiple services or work)
    		  ...
    		  Employee emp = new Employee("divya" , "divya@gmail.com"); // transient
...
//    		eData.setEmail("rushi@outlook.com");
//    		 System.out.println("Retreived the Data : " + eData);
//    		tx.commit();
//    		
...
//    		q1.setParameter("e", "rushi@outlook.com");
...
//            tx = session.beginTransaction();
//            
//            Employee emp1 = new Employee("siri" , "siri@gmail.com"); // transient
// 		   
