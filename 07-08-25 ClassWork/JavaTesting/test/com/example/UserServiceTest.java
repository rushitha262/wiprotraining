...
//	
	...
	void testValidUser() {
		// actual one
		assertTrue(us.isValidUser("rushitha", "1234567")); // assuming that this user name exist 
	}
	...
	void testShortPassword()
	{
		...
		assertTrue(us.isValidUser("rushitha", "1234567")); // checking the password length which should be greater than 6
	}
	...
	void testEmptyInput()
	{
		...
		assertFalse(us.isValidUser("rushitha", "")); // checking the empty fields 
	}
